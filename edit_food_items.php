...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    if($name != NULL){
      ...
      name='$name' where F_ID='$F_ID'");
      }

    if($price != NULL){
      $query = mysqli_query($conn, "UPDATE food set
      price='$price' where F_ID='$F_ID'");
      }
...
<div class="col-md-6">
  <table class="table table-striped">
    ...
    <?PHP
      ...
      $sql ="SELECT name, price, description FROM food WHERE F_ID=$update";
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDIT <?php echo strtoupper($row1['name']) ?>. </h3>
