...
$sql = "SELECT * FROM orders o LEFT JOIN customer c ON o.username = c.username WHERE o.R_ID IN (SELECT r.R_ID FROM RESTAURANTS r WHERE r.M_ID='$user_check') ORDER BY order_date";
